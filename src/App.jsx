...
export default function App() {
  ...
  // Màn hình làm bài thi độc lập (Full screen)
  ...
  <div className="p-8 max-w-5xl mx-auto space-y-6">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1">Tổng hợp tự động tất cả các câu bạn đã trả lời chưa chính xác trong các lần thi.</p>
      </div>
      <button
        onClick={() => {
        ...
        <div className="space-y-4">
          <div className="flex justify-end">
            <button
              ...
              className="px-5 py-2.5 bg-brand-800 hover:bg-brand-900 text-white font-bold text-xs rounded-xl shadow transition"
            >
          ...
          {activePage === 'question-bank' && (
            <QuestionBankPage onStartSession={handleStartExam} />
          )}
